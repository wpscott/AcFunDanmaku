...
namespace AcFunDanmu.Models.Client
{
    ...
    public sealed class GiftList
    {
        ...
        [JsonProperty("data")] public GiftData Data { get; set; }
    ...
    {
        [JsonProperty("giftList")] public Gift[] GiftList { get; set; }
        ...
        [JsonProperty("externalDisplayGift")] public ExternalDisplayGift ExternalDisplayGift { get; set; }
    }

    public sealed class Gift
    {
        [JsonProperty("giftId")] public long GiftId { get; set; }

        [JsonProperty("giftName")] public string GiftName { get; set; }

        [JsonProperty("arLiveName")] public string ArLiveName { get; set; }

        [JsonProperty("payWalletType")] public long PayWalletType { get; set; }

        [JsonProperty("giftPrice")] public int GiftPrice { get; set; }
        ...
        public Pic[]
            SmallPngPicList { get; set; }

        [JsonProperty("allowBatchSendSizeList")]
        public long[]
            AllowBatchSendSizeList { get; set; }

        [JsonProperty("canCombo")] public bool CanCombo { get; set; }

        [JsonProperty("canDraw")] public bool CanDraw { get; set; }

        [JsonProperty("magicFaceId")] public long MagicFaceId { get; set; }

        [JsonProperty("vupArId")] public long VupArId { get; set; }

        [JsonProperty("description")] public string Description { get; set; }

        [JsonProperty("redpackPrice")] public long RedpackPrice { get; set; }

        [JsonProperty("cornerMarkerText")] public string CornerMarkerText { get; set; }
    }
    ...
    public sealed class GiftInfo
    {
        ...
        [JsonProperty("pic")] public Uri Pic { get; set; }
    }
#endif
}