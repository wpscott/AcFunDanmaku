...
namespace AcFunDanmu.Models.Client
{
    ...
    public sealed record Play
    {
        ...
        [JsonPropertyName("data")] public PlayData Data { get; init; }
    ...
    public sealed record PlayData
    {
        ...
        [JsonPropertyName("videoPlayRes")] public string VideoPlayRes { get; init; }

        [JsonPropertyName("caption")] public string Caption { get; init; }

        [JsonPropertyName("ticketRetryCount")] public long TicketRetryCount { get; init; }

        [JsonPropertyName("ticketRetryIntervalMs")]
        public long TicketRetryIntervalMs { get; init; }

        [JsonPropertyName("notices")] public Notice[] Notices { get; init; }

        [JsonPropertyName("config")] public Config Config { get; init; }

        [JsonPropertyName("liveStartTime")] public long LiveStartTime { get; init; }
    ...
    public sealed record Notice
    {
        ...
        [JsonPropertyName("notice")] public string NoticeNotice { get; init; }
    }

    public sealed record Config
    {
        [JsonPropertyName("giftSlotSize")] public long GiftSlotSize { get; init; }
    }
#elif NETSTANDARD2_0_OR_GREATER
