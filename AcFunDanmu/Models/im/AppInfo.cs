...
namespace AcFunDanmu.Im.Basic {
  ...
  public static partial class AppInfoReflection {
    ...
    static AppInfoReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cg1BcHBJbmZvLnByb3RvEhNBY0Z1bkRhbm11LkltLkJhc2ljIukBCgdBcHBJ",
            "bmZvEg8KB2FwcE5hbWUYASABKAkSEgoKYXBwVmVyc2lvbhgCIAEoCRISCgph",
            "cHBDaGFubmVsGAMgASgJEhIKCnNka1ZlcnNpb24YBCABKAkSEwoLbGlua1Zl",
            "cnNpb24YBSABKAkSRgoNZXh0ZW5zaW9uSW5mbxgLIAMoCzIvLkFjRnVuRGFu",
            "bXUuSW0uQmFzaWMuQXBwSW5mby5FeHRlbnNpb25JbmZvRW50cnkaNAoSRXh0",
            "ZW5zaW9uSW5mb0VudHJ5EgsKA2tleRgBIAEoCRINCgV2YWx1ZRgCIAEoCToC",
            "OAFiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::AcFunDanmu.Im.Basic.AppInfo), global::AcFunDanmu.Im.Basic.AppInfo.Parser, new[]{ "AppName", "AppVersion", "AppChannel", "SdkVersion", "LinkVersion", "ExtensionInfo" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, })
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::AcFunDanmu.Im.Basic.AppInfoReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public AppInfo(AppInfo other) : this() {
      ...
      linkVersion_ = other.linkVersion_;
    ...
    /// <summary>Field number for the "linkVersion" field.</summary>
    public const int LinkVersionFieldNumber = 5;
    private string linkVersion_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string LinkVersion {
      get { return linkVersion_; }
      set {
        linkVersion_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(AppInfo other) {
      ...
      if (LinkVersion != other.LinkVersion) return false;
    ...
    public override int GetHashCode() {
      ...
      if (LinkVersion.Length != 0) hash ^= LinkVersion.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (LinkVersion.Length != 0) {
        output.WriteRawTag(42);
        output.WriteString(LinkVersion);
      }
    ...
    public int CalculateSize() {
      ...
      if (LinkVersion.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(LinkVersion);
      }
